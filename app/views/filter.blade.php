...
<!-- -->
      ...
      <div>
        ...
        <input name="before" type="text" class="datepicker" style="width: 74px;" value="<?= date('d.m.Y', time() + 3600*24*10) ?>">
        
        Количество ночей:<br/>
        <input name="nightsMin" type="text" style="width: 74px;" value="6">
        <input name="nightsMax" type="text" style="width: 74px;" value="14">
      </div>  
      <div>
        Валюта:<br/>
        <select name="currency" style="width: 179px">
        ...
        <input name="priceMax" type="text" style="width: 74px;" value="999999">
      </div>
<!-- -->
